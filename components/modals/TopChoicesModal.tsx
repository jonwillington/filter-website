...
interface TopChoicesModalProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export function TopChoicesModal({ isOpen, onClose }: TopChoicesModalProps) {
  return (
    <ResponsiveModal
      isOpen={isOpen}
      onClose={onClose}
    ...
    >
      <ModalBody className="p-6">
        ...
        <p className="text-text-secondary text-sm mb-6">
          Only the best shops in each city can make it into our Top Choices category.
        </p>
