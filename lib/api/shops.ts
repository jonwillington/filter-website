...
const SHOP_POPULATE = [
  ...
  // Suppliers - explicitly populate all needed fields
  ...
  'populate[brand][populate][suppliers][populate][logo][fields][0]=url',
  'populate[brand][populate][suppliers][populate][logo][fields][1]=formats',
  'populate[brand][populate][suppliers][populate][bg-image][fields][0]=url',
  'populate[brand][populate][suppliers][populate][bg-image][fields][1]=formats',
  'populate[brand][populate][suppliers][populate][country][fields][0]=code',
  'populate[brand][populate][suppliers][populate][country][fields][1]=name',
  'populate[brand][populate][suppliers][populate][ownRoastCountry][fields][0]=documentId',
  'populate[brand][populate][suppliers][populate][ownRoastCountry][fields][1]=name',
  'populate[brand][populate][suppliers][populate][ownRoastCountry][fields][2]=code',
  // Coffee partner - explicitly populate all needed fields
  ...
  'populate[brand][populate][coffee_partner][populate][logo][fields][0]=url',
  'populate[brand][populate][coffee_partner][populate][logo][fields][1]=formats',
  'populate[brand][populate][coffee_partner][populate][bg-image][fields][0]=url',
  'populate[brand][populate][coffee_partner][populate][bg-image][fields][1]=formats',
  'populate[brand][populate][coffee_partner][populate][country][fields][0]=code',
  'populate[brand][populate][coffee_partner][populate][country][fields][1]=name',
  // Other shop fields
