...
// Using 'any' types because raw Strapi data has extra fields not in our strict types

/* eslint-disable @typescript-eslint/no-explicit-any */

export const prefetchedShops: any[] = ${JSON.stringify(shops)};

export const prefetchedCountries: any[] = ${JSON.stringify(countries)};

export const prefetchedCityAreas: any[] = ${JSON.stringify(cityAreas)};

export const prefetchedBrands: any[] = ${JSON.stringify(brands)};
