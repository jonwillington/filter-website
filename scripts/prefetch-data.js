...
export const prefetchedShops: Shop[] = ${JSON.stringify(shops)};

export const prefetchedCountries: Country[] = ${JSON.stringify(countries)};

export const prefetchedCityAreas: CityArea[] = ${JSON.stringify(cityAreas)};

export const prefetchedBrands: Brand[] = ${JSON.stringify(brands)};
