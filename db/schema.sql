...
-- ─── Native app content (backend plan, Phase 2) ───────────────────────────────
-- Same DDL as db/migrations/0001_native_content.sql, generated from
-- workers/shared/native-content.ts. Written by workers/d1-reseed and workers/api (webhook).
